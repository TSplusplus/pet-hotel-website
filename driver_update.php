...
if(isset($_POST["driver_id"]) && !empty($_POST["driver_id"])){
    ...
    if(empty($driver_name_err) && empty($driver_phone_err)){
        ...
        $sql = "UPDATE driver SET driver_name=?, driver_phone=? WHERE driver_id=?";
         
        if($stmt = mysqli_prepare($conn, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssi", $param_driver_name, $param_driver_phone, $param_driver_id);
    ...
    if(isset($_GET["driver_id"]) && !empty(trim($_GET["driver_id"]))){ //checkว่ามีไอดีมั้ย
        // Get URL parameter
...
<head>
    ...
    <title>Update driver Information Page</title>
    ...
    <div class="content-container">
      <div class="section-c">
        ...
        <div class="homecontent-c">
          <div class="content">
            <div class="ct-h">
              <h2><strong>แก้ไขรถรับส่งลูกค้า</strong></h2>
            </div>
            ...
            <div class="ct-info">
              ...
              <div class="wrapper">
                    <div class="header">
                      <h2>รายละเอียดรถรับส่งลูกค้า</h2>
                    </div>
