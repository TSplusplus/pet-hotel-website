...
<body>
    ...
    <div class="head-danger">
                      <h2>ลบข้อมูล โรงแรม/ที่พัก</h2>
                    </div>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">

                            <input type="hidden" name="id" value="<?php echo trim($_GET["id"]); ?>"/>
                            <p>แอดมินต้องการลบ โรงแรม/ที่พัก นี้ใช่มั้ย ?</p><br>
                            <p>**ถ้าลบจากแอดมินแล้ว ทุกอย่างจะถูกลบทั้งหมด</p><br>
                            <p>
                                <input id="danger" type="submit" value="ใช่" class="btn">
                                <a href="admin_index.php" class="btn">ไม่</a>
                            </p>
                        </div>
                    </form>
                </div>
