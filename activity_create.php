...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    // Validate name
    $input_activity_name = trim($_POST["activity_name"]);//ตัดช่องว่างต้อนล้ะท้าย 
    ...
    if(empty($activity_name_err) && empty($activity_type_err)){
        ...
        $sql = "INSERT INTO activity_db (id ,activity_name, activity_type) VALUES (?, ?, ?)";

        if($stmt = mysqli_prepare($conn, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt,"iss",$param_id,$param_activity_name, $param_activity_type);
    ...
    <div class="content-container">
      <div class="section-c">
        ...
        <div class="homecontent-c">
          <div class="content">
            <div class="ct-h">
              <h2><strong>เพิ่มกิจกรรม</strong></h2>
            </div>
            ...
            <div class="ct-info">
              ...
              <div class="wrapper">
                    <p>กรอกรายละเอียดข้างล่างเพื่อเพิ่มกิจกกรรม</p>
                    <div class="header">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="input-group <?php echo (!empty($activity_type_err)) ? 'has-error' : ''; ?>">
                            ...
                            <select name="activity_type" class="form-control"  >
                                <option value="<?php echo $activity_type; ?>" selected="selected">--เลือกประเภทของกิจกรรม-- </option>
