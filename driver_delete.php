...
if(isset($_POST["driver_id"]) && !empty($_POST["driver_id"])){
    ...
    if($stmt = mysqli_prepare($conn, $sql)){
        ...
        // Set parameters
        $param_driver_id = trim($_POST["driver_id"]);
...
<body>
    ...
    <div class="head-danger">
                    ...
                    <form idaction="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                            ...
                            <input type="hidden" name="driver_id" value="<?php echo trim($_GET["driver_id"]); ?>"/>
                            <p>ต้องการลบรถรับส่งใช่มั้ย ?</p><br>
                            <p>
                                <input id="danger" type="submit" value="ใช่" class="btn">
                                <a href="host_driver.php" class="btn">ไม่</a>
                            </p>
                        </div>
                    </form>
                </div>
