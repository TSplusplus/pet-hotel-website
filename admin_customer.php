              ...
              <div class="wrapper">
                    ...
                    if($result = mysqli_query($conn, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            echo "<table id='customer'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        ...
                                        echo "<th><strong>อีเมล์</strong></th>";
                                        echo "<th><strong>เบอร์โทร</strong></th>";
                                        echo "<th><strong>ดูข้อมูล/แก้ไข/ลบ</strong></th>";
                                    echo "</tr>";
                                echo "</thead>";
                                echo "<tbody>";
                                while($row = mysqli_fetch_array($result)){
                                  if($row['role'] == "user"){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo "<a href='customer_read.php?id=". $row['id'] ."' title='View Record'><i class='fa fa-eye' aria-hidden='true'></i></a>";
                                            echo "<a href='customer_update.php?id=". $row['id'] ."' title='Update Staff Information Page' ><i class='fa fa-pencil' aria-hidden='true'></i></a>";
                                            echo "<a href='customer_delete.php?id=". $row['id'] ."' title='Delete Information Page' ><i class='fa fa-trash' aria-hidden='true'></i></a>";
                                        echo "</td>";
                                    echo "</tr>";
                            ...
                            echo "<p class='lead'><em>ไม่มีลูกค้า</em></p>";
                        }
                    } else{
