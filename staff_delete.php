...
if(isset($_POST["staff_id"]) && !empty($_POST["staff_id"])){
    ...
    $sql = "DELETE FROM staff_person WHERE staff_id = ?";
...
<body>
    ...
    <div class="head-danger">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                            ...
                            <input type="hidden" name="staff_id" value="<?php echo trim($_GET["staff_id"]); ?>"/>
                            <p>ต้องการลบชื่อพนักงานใช่มั้ย ?</p><br>
                            <p>
                                <input id="danger" type="submit" value="ใช่" class="btn">
                                <a href="host_staff.php" class="btn">ไม่</a>
                            </p>
                        </div>
                    </form>
                </div>
