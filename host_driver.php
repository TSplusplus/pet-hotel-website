...
#driver td, #customers th {
  border: 1px solid #ddd;
  padding: 8px 15px;
}

#driver tr:nth-child(even){background-color: #f2f2f2;}

#driver tr:hover {background-color: #ddd;}
    ...
    <div class="content-container">
      <div class="section-c">
        ...
        <div class="homecontent-c">
          <div class="content">
          <div class="ct-h">
              <h2><strong>รถรับส่งลูกค้า</strong></h2>
            </div>
            ...
            <div class="ct-info">
              <div class="wrapper">
                <div class="row">
                    ...
                    <a href="driver_create.php">เพิ่มรถรับส่งลูกค้า</a>
                    </div>
                    <?php
                    // Include config file
                    ...
                    if($result = mysqli_query($conn, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            echo "<table id='driver'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th><strong>ชื่อ</strong></th>";
                                        echo "<th><strong>เบอร์โทร</strong></th>";
                                  ...
                                  if($row['id']==$_SESSION['id']){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo "<a href='driver_update.php?driver_id=". $row['driver_id'] ."' title='Update Driver Information Page' ><i class='fa fa-pencil' aria-hidden='true'></i></a>";
                                            echo "<a href='driver_delete.php?driver_id=". $row['driver_id'] ."' title='Delete Information Page' ><i class='fa fa-trash' aria-hidden='true'></i></a>";
                                        echo "</td>";
                                    echo "</tr>";
                            ...
                            echo "<p class='lead'><em>คุณยังไม่มีรถรับส่งลูกค้า</em></p>";
                        }
                    } else{
